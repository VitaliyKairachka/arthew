...
public class CountryController {
    ...
    public List<CountryResponse> getAll(@Payload PageableRequest page) {
    ...
    @SendTo("/topic/country")
    public CountryResponse getById(@DestinationVariable Long id) {
        return countryService.getCountryById(id);
    }

    @MessageMapping("/country/name/{name}")
    @SendTo("/topic/country")
    public CountryResponse getByName(@DestinationVariable String name) {
        return countryService.getCountryByName(name);
    }

    @MessageMapping("/country/create")
    @SendTo("/topic/country")
    public CountryResponse create(@Payload CreateCountryRequest request) {
        return countryService.createCountry(request);
    }

    @MessageMapping("/country/update/{id}")
    @SendTo("/topic/country")
    public CountryResponse update(@DestinationVariable Long id, @Payload CountryDto countryDto) {
